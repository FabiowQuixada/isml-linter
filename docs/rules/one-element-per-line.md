...
- Content of `<textarea>`, `<script>`and `<style>` elements will be ignored since adding a new line break and spaces will actually add "empty" characters to the text area;
